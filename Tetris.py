...
TOPMARGIN = WINDOWHEIGHT - (BOARDHEGHT*BOXSIZE)-5
...
def main():
    ...
    while True: # this is the start of the game loop
...
def runGame():
    ...
    movingRight = False
    score = 0
    level, fallFreq = calculateLevelFallFreq(score)
